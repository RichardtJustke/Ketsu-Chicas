        ...
        <div className="w-full max-w-[410px] mx-auto lg:mx-0 animate-fade-in-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <div className="relative">
                  ...
                  <div className={`w-[18px] h-[18px] rounded-[2px] flex items-center justify-center transition-colors ${
                    formData.keepLoggedIn ? 'bg-crusta' : 'bg-[#E0E5F2]'
                  }`}>
              ...
              <Link 
                to="/esqueci-senha"
                className="font-['DM_Sans'] font-medium text-[14px] tracking-[-0.02em] text-crusta hover:text-crusta/80 transition-colors"
              >
                Esqueceu a senha?
              </Link>
            </div>
          ...
          <p className="mt-6 font-['DM_Sans'] text-[14px] tracking-[-0.02em]">
            <span className="text-[#707EAE]">Ainda não tem conta? </span>
            <Link 
              to="/criar-conta"
